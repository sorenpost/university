...
p1 <- ggscatter(col2010,
          ...
          add = "reg.line",
          palette = "jco") +
  stat_cor(aes(color = rents_10), label.x = 0.7, label.y = c(8, 8.2)) 


ggpar(p1, legend.title = "Resource rents as % of GDP:", font.legend = 12, font.tickslab = 10, font.x = 12, font.y = 12)
