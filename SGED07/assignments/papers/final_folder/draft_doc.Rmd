...
- Kan tasks ses som en rækk af links? I den meget simple model hvor alle inputs
kun har en t til at gå i stykker (fordi ellers kan deres inputs også gå i stykker, og så videre) og inputs sources tilføældigt, så er det vel den samme model som kramers, i.e. q^n n.
- https://www.youtube.com/watch?v=uWJlAloptaA                                                        
- https://jasoncollins.blog/2013/01/14/o-ring-and-foolproof-sectors/                                 
- Add to limitiations:
 - what if electricity shortages is not a key enough production input, or if firms tend to shift to using generators, the offset could be in smaller profit  
 - margins (profit divided by investment) and not necessarily observable in product complexity.
