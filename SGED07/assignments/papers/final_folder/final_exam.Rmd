...
The literature on economic complexity provides one possible answer. If some spill-over effects from the individual activities that arise from the relative specialization - like property rights, tacit know-how, infrastructure, regulation, institutions - cannot be imported, they needs to be present in the local economy. The productivity of a country then lies in these non-traded "economic capabilities", and some of the differences between countries owe to the number, complimentarity, and interactions of these capabilities [@hidalgo_product_2007; @hidalgo_building_2009]. 

The economic complexity-literature is concerned with quantifying these capabilities. While competing approaches exist [@tacchella_new_2012; @hidalgo_building_2009; @inoua_simple_2016] they share a common conceptual grounding. Given the difficulties in defining and measuring specific capabilities, researchers have taken at outcome based approach. If we think of

In the model in figure ... a country can only produce a product if it possess all the necessary capability-requirements (A's).
...
In this paper, I use the approach developed by.. (HH). Here, 

most widely applied 

[@hausmann_network_2011]
